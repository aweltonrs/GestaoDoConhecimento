		...
		<body>
			...
			<nav id="navbar">
				<ul>
					...
					<li onmousemove="mudaIcone('imagens/icone03.jpg')" onmouseout="mudaIcone('imagens/icone.jpg')"> <a href="ferramentas/cronus/cronometro/index.php"> Gestão do Conhecimento </a> </li>
					<li onmousemove="mudaIcone('imagens/icone04.jpg')" onmouseout="mudaIcone('imagens/icone.jpg')"> <a href="suporte.php"> Suporte </a> </li>
					<li onmousemove="mudaIcone('imagens/icone04.jpg')" onmouseout="mudaIcone('imagens/icone.jpg')"> <a href="org/conhecimento.php"> Institucional</a> </li>
				</ul>	
			</nav>
			
			<figure class="foto-legenda">
				<img src="imagens/tecnologia-880.jpg">
				<figcaption>
					<h3>Ordem ou Desordem?</h3>
					<p>A tecnologia sistematiza e agiliza as rotinas em sua volta.</p> 
				</figcaption>
			</figure>	
				<h1> Tudo o que você precisa a poucos clics de você </h1>
				<h2> Simplique sua vida aqui </h2>
				<h3> Estude-se apreda sobre si mesmo </h3>
